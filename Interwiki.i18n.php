...
Moontlik bestaan dit nie.',
	...
	'log-description-interwiki' => "Die is 'n logboek van veranderinge aan die [[Special:Interwiki|interwiki-tabel]].",
...
$messages['gl'] = array(
	...
	'interwiki_prefix_intro' => 'Prefixo interwiki a utilizar coa sintaxe de texto wiki <code>[<nowiki />[prefixo:<i>nome da páxina</i>]]</code>.',
	'interwiki_url' => 'URL',
	'interwiki-url-label' => 'URL:',
	'interwiki_url_intro' => 'Modelo para os enderezos URL. O marcador $1 será substituído polo <i>nome da páxina</i> do texto wiki ao usar a sintaxe do devantito texto wiki.',
	...
	'interwiki_trans_intro' => 'Se se utiliza a sintaxe de texto wiki <code>{<nowiki />{prefixo:<i>nome da páxina</i>}}</code>, entón:',
...
$messages['he'] = array(
	...
	'interwiki_url_intro' => 'תבנית עבור כתובות. ממלא המקום $1 יוחלף ב־<i>pagename</i> (שם הדף) של קוד הוויקי, כאשר נעשה שימוש בתחביר שהוזכר לעיל.',
	...
	'interwiki_trans_intro' => 'אם נעשה שימוש בתחביר <code>{<nowiki />{prefix:<i>pagename</i>}}</code>, אז:',
...
$messages['ko'] = array(
	...
	'interwiki_url_intro' => 'URL 서식. $1 자리에는 위에 위키문법이 쓰인 것에서의 <i>문서 이름</i>으로 치환될 것입니다.',
	...
	'interwiki_trans_intro' => '<code>{<nowiki />{prefix:<i>pagename</i>}}</code>이 쓰일 경우에는:',
...
인터위키 테이블의 [[Special:Log/interwiki|바뀜 기록]]이 존재합니다.',
	...
	'interwiki-cached' => '인터위키 데이터는 캐시됩니다. 캐시를 변경하는 건 불가능합니다.',
	'interwiki_edit' => '편집',
...
$messages['mk'] = array(
	...
	'interwiki-desc' => 'Додава [[Special:Interwiki|специјална страница]] за преглед и уредување на меѓувики-табелата',
	'interwiki_intro' => 'Ова е преглед на меѓувики-табелата.',
	...
	'interwiki_prefix_intro' => 'Меѓувики-префикс за користење во синтаксата на викитекстот <code>[<nowiki />[префикс:<i>име на страница</i>]]</code>.',
	'interwiki_url' => 'URL',
	'interwiki-url-label' => 'URL:',
...
Постои [[Special:Log/interwiki|дневник на промени]] во меѓувики-табелата.',
	...
	'interwiki_deleted' => 'Префиксот „$1“ е успешно отстранет од меѓувики-табелата.',
	'interwiki_delfailed' => 'Префиксот „$1“ не можеше да се отстрани од меѓувики-табелата.',
	...
	'interwiki_added' => 'Префиксот „$1“ е успешно додаден кон меѓувики-табелата',
	'interwiki_addfailed' => 'Префиксот „$1“ не можеше да се додаде во меѓувики-табелата.
...
Запомнете дека ова може да ги раскине постоечките врски.',
	'interwiki_edited' => 'Префиксот „$1“ е успешно изменет во меѓувики-табелата.',
	'interwiki_editerror' => 'Префиксот „$1“ не може да се менува во меѓувики-табелата.
Можеби тој не постои.',
	...
	'log-name-interwiki' => 'Дневник на измени во меѓувики-табелата',
	...
	'log-description-interwiki' => 'Ова е дневник на промени во [[Special:Interwiki|меѓувики-табелата]].',
...
$messages['zh-hans'] = array(
	...
	'interwiki_prefix_intro' => '跨wiki前缀，用于<code>[<nowiki />[prefix:<i>pagename</i>]]</code>wiki语法。',
	'interwiki_url_intro' => 'URL模板。当使用上述wiki语法时，占位符$1将被<i>pagename</i>替换。',
	'interwiki_local' => '转发',
	...
	'interwiki_trans_intro' => '如果使用wiki语法<code>{<nowiki />{prefix:<i>pagename</i>}}</code>，那么：',
...
$messages['zh-hant'] = array(
	...
	'interwiki_url_intro' => 'URL的模板，當使用上述語法時，佔位符$1將會替換成<i>pagename</i>。',
	'interwiki_local' => '轉發',
