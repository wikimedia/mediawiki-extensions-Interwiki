...
$messages['en'] = array(
	...
	'interwiki_local_0_intro' => 'not honored, a "{{int:badtitle}}" error page will be displayed instead.',
	'interwiki_local_1_intro' => 'redirected to the target URL given in the interwiki link definitions (i.e. treated like links to local pages).',
...
$messages['es'] = array(
	...
	'interwiki_local_0_intro' => 'no será satisfecha, en su lugar se mostrará una página de error "{{int:badtitle}}".',
	'interwiki_local_1_intro' => 'será remitida a la URL objetivo definida en los enlaces de interwiki (es decir, se tratarán como enlaces a páginas locales).',
...
$messages['fa'] = array(
	...
	'interwiki_local_1_intro' => 'هدایت به نشانی اینترنتی مورد نظر داده‌‌شده در تعاریف پیوند ویکی داخلی (یعنی مانند پیوندها در صفحات داخلی مطرح می‌شود).',
...
$messages['hsb'] = array(
	...
	'interwiki_local_1_intro' => 'k cilowemu URL pódany w definicijach wotkaza interwiki (t. j. wobchadźa so z tym kaž z wotkazami w lokalnych stronach).',
...
$messages['nl'] = array(
	...
	'interwiki_local_0_intro' => 'wordt niet verwerkt, in plaatst daarvan worden een foutpagina "{{int:badtitle}}" weergegeven.',
	'interwiki_local_1_intro' => "doorverwezen naar de doel-URL die opgegeven is in de definities van de interwikikoppelingen (deze worden behandeld als koppelingen naar lokale pagina's)",
...
$messages['oc'] = array(
	...
	'interwiki_local_1_intro' => "redirigit cap a l'URL cibla en foncion de las definicions del ligam interwiki (es a dire tractat coma de ligams cap a de paginas del wiki)",
...
There is ae [[Special:Log/interwiki|log o chynges]] til the interwiki buird.',
	'interwiki_1' => 'ai',
	'interwiki_0' => 'naw',
