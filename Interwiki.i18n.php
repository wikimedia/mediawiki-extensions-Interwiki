...
$messages['de'] = array(
	...
	'interwiki_prefix_intro' => 'Interwikipräfix zur Verwendung in der Form <code>[<nowiki />[präfix:<em>Seitenname</em>]]</code> im Wikitext.',
	'interwiki_url_intro' => 'Muster für URLs. Der Platzhalter $1 wird bei der Verwendung durch <em>Seitenname</em> aus der oben genannten Syntax im Wikitext ersetzt.',
	...
	'interwiki_trans_intro' => 'Wenn Vorlagensyntax <code>{<nowiki />{präfix:<em>Seitenname</em>}}</code> verwendet wird, dann:',
